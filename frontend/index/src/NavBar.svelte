<script lang="ts">
    ...
    async function gauge() {
        loadingButtons.GAUGE = true;
        await new Promise(resolve => setTimeout(resolve, 2000));
        loadingButtons.GAUGE = false;
    }
</script>
...
<nav>
    <RoundButton showSpinner={loadingButtons.UPLOAD} on:click={upload}>UPLOAD</RoundButton>
    ...
    <RoundButton showSpinner={loadingButtons.GAUGE} on:click={gauge}>GAUGE</RoundButton>
</nav>
